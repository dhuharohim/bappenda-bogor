    ...
    <div class="warp">
        <div class="container-fluid px-4">
            <div class="card shadow mb-3 mt-4 w-auto ">
                <form action="{{ route('kepala.update', ['id' => $profile_kepalaKantor['id']]) }}" method="post">
                    @csrf
                            ...
                            <div class="col">
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        ...
                                        <option value="{{ $profile_kepalaKantor->status }}"> {{ $profile_kepalaKantor->status }}
                                        </option>
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" class="form-control" id="absen" name="absen"
                                        value="{{ $profile_kepalaKantor->absen }}">
                                </div>
                            ...
                            <div class="col">
                                <div class=" form-group mb-3">
                                    ...
                                    <input type="number" class="form-control" id="handphone" name="handphone" required
                                        value="{{ $profile_kepalaKantor->handphone }}">
                                </div>
                                <div class=" form-group mb-3">
                        ...
                        <div class="col">
                            <div class="mb-3 form-group">
                                ...
                                <select name="kabupaten" id="kabupaten" class="form-control">
                                    <option value="{{ $profile_kepalaKantor->kabupaten }}">
                                        {{ $profile_kepalaKantor->kabupaten }}</option>
                            ...
                            <div class=" form-group mb-3">
                                ...
                                <select name="kecamatan" id="kecamatan" class="form-control">
                                    <option value="{{ $profile_kepalaKantor->kecamatan }}">
                                        {{ $profile_kepalaKantor->kecamatan }}</option>
                        ...
                        <div class="col">
                            <div class="mb-3 form-group">
                                ...
                                <input type="text" class="form-control" id="birthdate" name="kelurahan" required
                                    value="{{ $profile_kepalaKantor->kelurahan }}">
                            </div>
                            <div class=" form-group mb-3">
                                <label for="alamat_lengkap" class="form-label">{{ __('Alamat Lengkap*') }}</label>
                                <textarea class="form-control" name="alamat_lengkap" id="alamat_lengkap" value="">{{ $profile_kepalaKantor->alamat_lengkap }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
